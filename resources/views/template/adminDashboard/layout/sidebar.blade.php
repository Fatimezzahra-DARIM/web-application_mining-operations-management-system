<aside id="separator-sidebar"
   class="pt-16 fixed top-0 left-0 z-40 w-64 h-screen  transition-transform -translate-x-full  border-r border-gray-200 sm:translate-x-0 dark:bg-[#3f3f46] dark:border-gray-700" aria-label="Sidebar"
    aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto" >
        <ul class="space-y-2 font-medium">
                ...
                {{-- /////// --}}
                         ...
                         <li>
                            <a href="{{route('task')}}"
                                ...
                                <span class="ml-3">Task to do</span>
                            </a>
                        </li>
                         @endrole
                        {{-- /////// --}}
            ...
            <li>
                <a href="{{route('taskFile')}}"
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">Manage Task Files</span>
                    {{-- <span
        ...
        <ul class="pt-2 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
